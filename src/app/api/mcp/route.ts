...
function createBrainMcp(): McpServer {
  ...
  server.tool(
    "search_thoughts",
    "Search your Engram by meaning using semantic vector search.",
    {
  ...
  server.tool(
    "list_thoughts",
    "Browse recent thoughts in your Engram chronologically.",
    {
...
export async function POST(req: Request) {
  ...
  try {
    ...
    // Pass through SSE or JSON responses
